...
class test_for_base_model(unittest.TestCase):
    ...
    def test_BaseModel(self):
        ...
        self.assertEqual(
            self.my_model.name, my_model_json['name']
        )
        self.assertEqual(
            self.my_model.my_number, my_model_json['my_number']
        )
        self.assertEqual(
            'BaseModel', my_model_json['__class__']
        )
        self.assertEqual(
    ...
    def test_inst(self):
        """check class """
        ml = BaseModel()
        self.assertIsInstance(ml, BaseModel)
